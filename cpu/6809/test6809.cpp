//
// test6809.cpp
// Functional test runner for the MC6809 emulator.
//
// The test binary covers addresses $0400–$FFFF (64512 bytes).
...
static constexpr Word success_addr = 0x0986;

static constexpr size_t HISTORY = 16;

class Test6809 : public mc6809 {
public:
	Word trap_pc = 0;
...
{
	const char *binfile = (argc == 2) ? argv[1] : "tests/test6809.bin";
