...
As of January 2021 support for interrupts was implemented, and the code
was reorganised so that complete machines are generated by creating
instances of a CPU, memory devices and peripherals and then "attaching"
those to each other.  See cpu/6809/main09.cpp for an example of how this
is done.
